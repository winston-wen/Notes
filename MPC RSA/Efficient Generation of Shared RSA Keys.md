**Procedure. Semi-primality test.** Assume $$p, q$$ be positive random integers with $$p\equiv q\equiv 3\pmod 4$$. Let $$n=pq$$.
...
**Lemma 2.** If $$n$$ is a product of two distinct primes, then the above procedure always succeeds. Otherwise, the procedure fails with probability at least $$1/2$$, over the choice of $$g$$.
